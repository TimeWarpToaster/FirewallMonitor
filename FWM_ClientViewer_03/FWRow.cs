...
namespace FWM_ClientViewer_03
{
    public class FWRow
    {
        ...
        public FWRow(FWRow from, bool copyLists)
        {
        ...
        public bool toBinary(ref BinaryWriter writer)
        {
            ...
            try
            {
                ...
                writer.Write(this.ActiveDate == null ? "" : this.ActiveDate.ToString(TAG.DTF));
                writer.Write(this.Expiry == null ? "" : this.Expiry.ToString(TAG.DTF));
                writer.Write(this.Expired);
                writer.Write(this.Deactivated == null ? "" : this.Deactivated.ToString(TAG.DTF));
        ...
        public JObject toJObjectForGrid()
        {
            ...
            try
            {
                ...
                data.Add("Port", this.Port);
                data.Add("FWName", this.FWName);
                data.Add("CreateDateTime", 
                    this.CreateDateTime == null || this.CreateDateTime == c.nDt ? "" : this.CreateDateTime.ToString(TAG.DTF));
                //data.Add("Active", this.Active);
                data.Add("Expired", this.Expired);
                data.Add("Expiry", this.Expiry == null || this.Expiry == c.nDt ? "" : this.Expiry.ToString(TAG.DTF));
                data.Add("ActiveDate", this.ActiveDate == null || this.ActiveDate == c.nDt ? "" : this.ActiveDate.ToString(TAG.DTF));
                data.Add("Deactivated", 
                    this.Deactivated == null || this.Deactivated <= c.nDt ? "" : this.Deactivated.ToString(TAG.DTF));
                //data.Add("TimesRefreshed", this.TimesRefreshed);
