    ...
    public partial class Form1 : Form
    {
        ...
        public bool initApp()
        {
            ...
            try
            {
                ...
                // Enable logging
                if (!L.logInit(U.GetSetting2("logPathViewer", ""), lbLogsOut, U.GetSetting2("EnableFileLogging", true)))
                {
            ...
            try
            {
                ...
                Thread thread = new Thread(() =>
                {
                    try
                    {
                        ...
                        Thread.Sleep(100);// This is for the file to finish becoming accessible at OS level
                        ...
                        {
                            L.l(location, "Rules from storage were null.");
                            DataMgr.FWRows = new List<FWRow>();
                            MessageBox.Show(
                                "Failed to read firewall file, likely due to being busy by another app.\n\nPlease try again after a moment.",
                                "Error Reading File");
                        }
                        else
                        {
        ...
        public JArray getSettingsForDisplay()
        {
            ...
            try
            {
                ...
                obj.Add("Value", U.GetSetting2("baseDirectory", ""));
                ...
                obj.Add("Value", U.GetSetting2("EnableFileLogging", true));
                ...
                obj.Add("Value", U.GetSetting2("EnableAutomaticReport", true));
                ...
                obj.Add("Value", U.GetSetting2("isHeadless", true));
                ...
                obj.Add("Value", U.GetSetting2("DaysToKeepData", 30));
                obj.Add("DisplayName", "Days To Keep Data:  ");
                obj.Add("Description",
                ...
                obj.Add("Value", U.GetSetting2("maxToProcess", 100000));
                ...
                obj.Add("Value", U.GetSetting2("instanceName", "FWMClient-Unset"));
                ...
                obj.Add("Value", U.GetSetting2("allowMultiInstance", false));
                ...
                obj.Add("Value", U.GetSetting2("ApprovedIps", ""));
                ...
                obj.Add("Value", U.GetSetting2("EventFolder", ""));
                ...
                obj.Add("Value", U.GetSetting2("ReportFilePrefix", "Rpt_"));
                ...
                obj.Add("Value", U.GetSetting2("IsManageFW", false));
                ...
                obj.Add("Value", U.GetSetting2("MinFailuresToBlock", 20));
                ...
                obj.Add("Value", U.GetSetting2("FWPrefix", "FWMRule"));
                ...
                obj.Add("Value", U.GetSetting2("MSBetweenFWTestMin", 30));
                obj.Add("DisplayName", "Min MS Between Firewall Tests:  ");
                obj.Add("Description", 
                    "The MS (millisecond) values are somewhat arbitrary, and are really only intended to prevent spamming the firewall with lookups and rule changes, in the event many changes are needed at-once.");
                retVal.Add(obj);

                obj = new JObject();
                obj.Add("Key", "MSBetweenFWTestMax");
                obj.Add("Value", U.GetSetting2("MSBetweenFWTestMax", 60));
                ...
                obj.Add("Value", U.GetSetting2("MSBetweenFWAddMin", 200));
                ...
                obj.Add("Value", U.GetSetting2("MSBetweenFWAddMax", 400));
                ...
                */
                ...
                obj.Add("Value", U.GetSetting2("FWMinutesToReview", 10080));
                ...
                obj.Add("Value", U.GetSetting2("FWExpireAfterMinutes", 10080));
                ...
                obj.Add("Value", U.GetSetting2("FWExpireAfterDays", 30));
                ...
                */
                ...
                obj = new JObject();
                obj.Add("Key", "FWPort");
                obj.Add("Value", U.GetSetting2("FWPort", ""));
                ...
                */
                ...
                obj.Add("Value", U.GetSetting2("FWProtocol", ""));
            ...
            try
            {
                ...
                for (int idxEvent = 0; idxEvent < events.Count; idxEvent++)
                {
                    ...
                    if (idxIp < 0)
                    {
                        ...
                        if (record == null)
                        {
                            L.err(location, "Failed to locate IP (" + events[idxEvent].IpAddress + ") in memory.");
                            continue;
                        }
        ...
        public bool loadSettingsTab2()
        {
            const string location = CLASSNAME + ".loadSettingsTab2";
            bool retVal = false;
            try
            {
                // Validate memory
                ...
                if (jarr == null)
                {
                    L.err(location, "Settings in memory were null.");
                    return retVal;
                }
                ...
                //JArray jarr = getSettingsForDisplay();
                L.l(location, "Iterating (" + jarr.Count + ") settings to display.");
                float fontSizeLabels = 10f;
                for (int i = 0; i < jarr.Count; i++, row++)
                {
                    JObject jobj = (JObject)jarr[i];
                    if (jobj.ContainsKey("Visible"))
                    {
                        if ("false" == Convert.ToString(jobj["Visible"]).ToLower())
                        {
                            // Do not bother to create hidden settings
                            continue;
                        }
                    }
                    bool enabled = false;
                    if (jobj.ContainsKey("Edit"))
                    {
                        if ("true" == Convert.ToString(jobj["Edit"]).ToLower())
                        {
                            enabled = true;
                        }
                    }
                    ...
                    Label label = new Label()
                    {
                        Text = U.getString(jobj, "Label", ""),
                        Width = 200,
                        TextAlign = ContentAlignment.TopLeft,
                        AutoSize = false,
                        Dock = DockStyle.Fill
                    };
                    label.Font = new Font(label.Font.FontFamily, fontSizeLabels, label.Font.Style);
                    TextBox tb = new TextBox()
                    {
                        Name = "tbGeneric" + U.getString(jobj, "Key", i.ToString()),
                        Text = Convert.ToString(jobj["Value"]),
                    ...
                    lblDesc.Font = new Font(lblDesc.Font.FontFamily, fontSizeLabels, lblDesc.Font.Style);
        ...
        public bool saveSettingsTab()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < settingsInput.Count; i++)
                {
                    ...
                    if (!U.SetSetting2(key, settingsInput[i].Text))
                    {
                        cntSaveErrors++;
        ...
        public bool saveSettingsTab2()
        {
            const string location = CLASSNAME + ".saveSettingsTab2";
            bool retVal = false;
            try
            {
                if (settingsInput == null)
                ...
                for (int i = 0; i < settingsInput.Count; i++)
                {
                    ...
                    {
                        cntSaveErrors++;
                        L.err(location, "Failed to set setting (" + key + ") in memory to (" + settingsInput[i].Text + ").");
                    }
                }
